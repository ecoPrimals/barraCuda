...
- `shaders` — 826 WGSL shaders, 15-tier precision continuum (Binary→DF128), sovereign compiler pipeline
...
### VFIO GPU Dispatch (`vfio` — **primary dispatch path**, S156 infrastructure complete)
