...
mod tests {
    ...
    fn ml_pipeline_methods_are_protected() {
        ...
        assert_eq!(classify_method("ml.mlp_save"), MethodAccessLevel::Protected);
        assert_eq!(classify_method("ml.mlp_load"), MethodAccessLevel::Protected);
        assert_eq!(
    ...
    fn btsp_and_mesh_are_public() {
        assert_eq!(classify_method("btsp.negotiate"), MethodAccessLevel::Public);
        assert_eq!(
