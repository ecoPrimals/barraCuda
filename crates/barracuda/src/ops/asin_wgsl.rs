...
impl Asin {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let metadata_buffer = device.create_uniform_buffer("Asin Metadata", &metadata);

        ComputeDispatch::new(device, "asin")
            .shader(include_str!("../shaders/math/asin_f64.wgsl"), "main")
