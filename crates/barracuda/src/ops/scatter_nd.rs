...
impl ScatterNd {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        ComputeDispatch::new(device, "ScatterNd")
            .shader(
                include_str!("../shaders/tensor/scatter_nd_f64.wgsl"),
                "main",
            )
            ...
            .storage_read(5, &indices_shape_buffer)
            .storage_read(6, &values_shape_buffer)
