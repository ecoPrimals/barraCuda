...
impl Erf {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let metadata_buffer = device.create_uniform_buffer("ERF Metadata", &metadata);

        ComputeDispatch::new(device, "erf")
            .shader(include_str!("../shaders/math/erf_f64.wgsl"), "main")
