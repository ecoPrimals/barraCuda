...
- **1,208 Rust source files**, 25 integration test harnesses, 4,996 tests passing
...
│       ├── tests/                   # 49 integration test files (25 harnesses + submodules)
...
cargo nextest run --workspace --profile ci  # 4,996+ tests via nextest
