...
//
// logsumexp_reduce_f32.wgsl — Batched numerically-stable log-sum-exp (f32)
//
...
//
// Uses: HMM forward/backward, phylogenetics log-likelihood, softmax prep.
// See also: logsumexp_reduce_f64.wgsl for f64 variant.
