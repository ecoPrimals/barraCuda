...
**728 Production WGSL Shaders** (803 total including ops/) | 3-Tier Precision (f32/f64/df64) | Cross-Vendor Compatible
...
**Shader Count**: 728 in shaders/ (803 total with ops/) — organized by domain, all f64 canonical. DF64 emulated double-precision on hardware without native f64.  
