...
// ── Phase 3 negotiate (extracted to btsp_negotiate.rs) ──────────────

pub use super::btsp_negotiate::{NegotiateError, NegotiateResult, negotiate_phase3};

// ── NDJSON wire helpers (extracted to btsp_wire.rs) ─────────────────

pub(super) use super::btsp_wire::{read_ndjson_line, write_ndjson_line};
