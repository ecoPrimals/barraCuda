...
impl Lgamma {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let metadata_buffer = device.create_uniform_buffer("LGAMMA Metadata", &metadata);

        ComputeDispatch::new(device, "lgamma")
            .shader(include_str!("../shaders/math/lgamma_f64.wgsl"), "main")
