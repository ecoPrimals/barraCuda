...
description = "GPU-accelerated scientific computing engine — 5,031 tests, 101 IPC methods, 15-tier precision ladder, pure safe Rust, A+ grade"
date = 2026-08-07
...
- **5,031 tests** (cargo test --workspace), 0 failed, 80.54% line / 83.45% function coverage
