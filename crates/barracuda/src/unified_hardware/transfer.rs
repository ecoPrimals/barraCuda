...
//!
//! Sysfs probing lives in [`super::pcie_probe`]; this module owns the
//! cost model, bandwidth tiers, and mixed-substrate routing policy.

pub use super::pcie_probe::PcieLinkInfo;
