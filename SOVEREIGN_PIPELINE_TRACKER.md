...
```
Layer 1  barraCuda    ██████████  COMPLETE       v0.4.0 stadial gate, 101 IPC methods, ML pipeline, mesh trust, trio E2E validated
...
| Need | Status | Notes |
|------|--------|-------|
| WGSL shaders parseable by naga | Done | 859 shaders, all naga-valid |
