...
impl Hardshrink {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let params_buffer = device.create_uniform_buffer("Hardshrink Params", &params);

        ComputeDispatch::new(device, "hardshrink")
            .shader(
                include_str!("../shaders/activation/hardshrink_f64.wgsl"),
                "main",
            )
