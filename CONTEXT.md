...
- **Tests:** 4,600+ (3,815 lib + 16 naga-exec + 229 core + 297 doc)
...
- **Rust files:** 1,113 source files, 42 integration test files
...
30 methods following wateringHole `{domain}.{operation}` Semantic Method Naming Standard.
