...
impl Op {
    ...
    pub fn stride(&self) -> usize {
        match self {
            ...
            Self::HargreavesEt0 => 4,
            Self::KcClimateAdjust => 4,
            Self::DualKcKe => 9,
            Self::VanGenuchtenTheta => 5,
            Self::VanGenuchtenK => 7,
            Self::ThornthwaiteEt0 => 5,
            Self::Gdd => 1,
            Self::PedotransferPolynomial => 7,
            Self::MakkinkEt0 => 3,
            Self::TurcEt0 => 3,
            Self::HamonEt0 => 2,
            Self::ScsCnRunoff => 3,
            Self::StewartYieldWater => 2,
            Self::BlaneyCriddleEt0 => 2,
        }
    }
}
