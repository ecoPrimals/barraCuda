...
impl Cumprod {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let params_buffer = device.create_uniform_buffer("Cumprod Params", &params);

        ComputeDispatch::new(device, "Cumprod")
            .shader(include_str!("../shaders/reduce/cumprod.wgsl"), "main")
