...
//
// perlin_2d_f32.wgsl — Batch 2D Perlin noise (f32)
//
...
//
// f32 variant for game/real-time use (ludoSpring). Identical algorithm
// to perlin_2d_f64.wgsl but with f32 types — no f64 extension needed.
//
