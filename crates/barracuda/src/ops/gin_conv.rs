...
impl GinConv {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        batch.push(
            ComputeDispatch::new(device, "GINConv MLP")
                .shader(shader_source, "apply_mlp")
                .uniform(0, &params_buffer)
                .storage_read(1, self.node_features.buffer())
                .storage_read(2, &edge_buffer)
                .storage_read(3, self.mlp_weights.buffer())
