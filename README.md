...
- **1,211 Rust source files**, 25 integration test harnesses, 5,035 tests passing
...
│       ├── tests/                   # 48 integration test files (25 harnesses + submodules)
...
cargo nextest run --workspace --profile ci  # 5,035+ tests via nextest
