...
- **1,116 Rust source files**, 25 integration test harnesses, 4,366+ tests passing via nextest CI profile
...
cargo nextest run --workspace --profile ci  # 4,366+ tests via nextest
