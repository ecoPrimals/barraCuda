...
pub const WGSL_MAX_SIMPLE: &str = include_str!("../shaders/math/max_simple_f64.wgsl");

/// Basic max reduction shader (f64 canonical).
pub const WGSL_MAX_BASIC: &str = include_str!("../shaders/math/max_f64.wgsl");
...
impl Max {
    ...
    fn wgsl_shader_reduce() -> &'static str {
        include_str!("../shaders/math/max_reduce_f64.wgsl")
    }

    /// Get the WGSL shader source for dimension-wise reduction
    fn wgsl_shader_dim() -> &'static str {
        include_str!("../shaders/math/max_dim_f64.wgsl")
    }
