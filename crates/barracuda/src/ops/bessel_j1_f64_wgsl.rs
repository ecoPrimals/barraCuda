...
impl BesselJ1F64 {
    ...
    fn j1_scalar(x: f64) -> f64 {
        ...
        if ax >= 8.0 {
            ...
            let p1 = 2.40337019e-6f64.mul_add(
                -z8,
                2.457520174e-5f64.mul_add(
                    z6,
                    3.516396496e-4f64.mul_add(-z4, 1.83105e-3f64.mul_add(z2, 1.0)),
                ),
            );

            let q1 = (1.057874120e-7_f64 * z).mul_add(
                z8,
                (8.8228987e-7_f64 * z).mul_add(
                    -z6,
                    (8.449199096e-6_f64 * z)
                        .mul_add(z4, 4.687499995e-2f64.mul_add(z, -(2.002690873e-4 * z * z2))),
                ),
            );
            ...
            let p = 30.16036606f64.mul_add(
                -z5,
                15704.48260f64.mul_add(
                    z4,
                    2972611.439f64.mul_add(
                        -z3,
                        242396853.1f64.mul_add(z2, 7895059235.0f64.mul_add(-z, 72362614232.0)),
                    ),
                ),
            );
            ...
            let q = 1.0_f64.mul_add(
                z5,
                376.9991397f64.mul_add(
                    z4,
                    99447.43394f64.mul_add(
                        z3,
                        18583304.74f64.mul_add(z2, 2300535178.0f64.mul_add(z, 144725228442.0)),
                    ),
                ),
            );
