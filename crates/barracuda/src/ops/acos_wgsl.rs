...
impl Acos {
    ...
    pub fn execute(self) -> Result<Tensor> {
        ...
        let metadata_buffer = device.create_uniform_buffer("ACOS Metadata", &metadata);

        ComputeDispatch::new(device, "acos")
            .shader(include_str!("../shaders/math/acos_f64.wgsl"), "main")
