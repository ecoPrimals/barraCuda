...
```
Layer 1  barraCuda    ██████████  COMPLETE       v0.4.0 stadial gate, 98 IPC methods, ML pipeline, mesh trust, trio E2E validated
...
| Need | Status | Notes |
|------|--------|-------|
| WGSL shaders parseable by naga | Done | 860 shaders, all naga-valid |
